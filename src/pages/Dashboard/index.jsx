                    ...
                    <div className="table-responsive">
                      <table className="table">
                        ...
                        <tbody>
                          <tr>
                            <td>
                                <img src="assets/images/faces/face1.jpg" alt="image" className="me -2" /> David Grey
                            </td>
                          ...
                          <tr>
                            <td>
                                <img src="./assets/images/faces/face2.jpg" alt="image" className="me-2" /> Stella Johnson
                            </td>
